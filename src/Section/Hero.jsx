...
/>
              ...
              <div className="justify-start">
                ...
                <h2 className="font-rubik text-[20px] font-bold leading-7.5 text-text">Freelancer delivering exceptional Webflow, and Next.js solutions.</h2>
                <p className="mt-[19.4px] mb-[38.98px] font-rubik text-base font-normal leading-[25.6px] text-text2">I am a skilled freelancer specializing in Webflow development, Figma design, and Next.js projects. I deliver creative, dynamic, and user-centric web solutions.</p>
                <div>
